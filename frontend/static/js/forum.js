      ...
      contents.innerHTML = `
        ...
        <div class="post-actions">
          <div class="action active ${isLikedByUser ? 'clicked' : ''}"   id="likes" data-liked="${isLikedByUser ? 'true' : 'false'}" data-like="like" data-id_card="${ele.Card_Id}" >
           ...
           <div class="action disliked  ${isdisLikedByUser ? 'clicked_disliked' : ''}" id="" data-like="Dislikes" data-liked="${isdisLikedByUser ? 'true' : 'false'}" data-like="dislike" data-id_card="${ele.Card_Id}">
            <svg width="20" height="20" viewBox="0 0 20 20" fill="currentColor">
